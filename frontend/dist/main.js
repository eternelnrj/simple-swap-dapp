...
},{"../build/contracts/IERC20.json":1,"../build/deployments/42/0xec0429a31d86da174AC7246004A465B90DF47225.json":2}],6:[function(require,module,exports){
"use strict";
...
async function swap() {
  ...
  if (amountSoldToken <= 0) {
    ...
    const amountSoldTokenStr = (0, _secondary_functions.getBigNumberWithDecimals)(amountSoldToken, numberDecimalsSoldToken).multipliedBy(1.1).toString();
