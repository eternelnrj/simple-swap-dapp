...
async function changeUsdcInput(tokenForSale) {
  if (tokenForSale == 0) {
    document.getElementById("usdc-input").value = (0, _price_functions.calculateAmountPurchasedToken)(document.getElementById("link-input").value, tokenForSale);
  } else {
    document.getElementById("usdc-input").value = (0, _price_functions.calculateAmountSoldToken)(document.getElementById("link-input").value, tokenForSale);
  }
}

async function changeLinkInput(tokenForSale) {
  if (tokenForSale == 0) {
    document.getElementById("link-input").value = await (0, _price_functions.calculateAmountSoldToken)(document.getElementById("usdc-input").value, tokenForSale);
  } else {
    document.getElementById("link-input").value = await (0, _price_functions.calculateAmountPurchasedToken)(document.getElementById("usdc-input").value, tokenForSale);
  }
}
...
function changeMinAmountReceived(tokenForSale) {
  ...
  document.getElementById("min_amount_purchased_token").innerHTML = "Min amount of" + tokenPurchasedStr + "to receive: " + minAmountPurchasedToken.toString();
...
async function changeAmountUsdcToSupply() {
  ...
  const [lpTokenPriceLink, lpTokenPriceUsdc] = await (0, _price_functions.getLpTokenPrice)();
...
},{"./price_functions.js":6}],4:[function(require,module,exports){
"use strict";
...
},{"../build/contracts/IERC20.json":1,"../build/deployments/42/0xec0429a31d86da174AC7246004A465B90DF47225.json":2}],5:[function(require,module,exports){
...
async function calculateAmountSoldToken(amountPurchasedToken, tokenForSale) {
  const totalLinkAvaialbe = await (0, _secondary_functions.getTotalAvailableLinkBigNumberWithDecimals)();
  const totalUsdcAvailable = await (0, _secondary_functions.getTotalAvailableUsdcBigNumberWithDecimals)();
  console.log("quantitySoldToken: " + amountSoldToken);
...
},{"./contracts_and_abi.js":4,"./secondary_functions.js":7,"bignumber.js":5}],7:[function(require,module,exports){
"use strict";
...
},{"./contracts_and_abi.js":4,"bignumber.js":5}]},{},[3]);
